...
public:
	...
	/*
	 * @get image at sequenceCounter + sequenceCorrection, and reset sequenceCounter to sequenceCounter + sequenceCorrection
	 * @param leftImg  left image
	 * @param rightImg right image
	 * @return false when image sequence end
	 */
	bool update(cv::Mat& leftImg, cv::Mat& rightImg, int sequenceCorrection);
