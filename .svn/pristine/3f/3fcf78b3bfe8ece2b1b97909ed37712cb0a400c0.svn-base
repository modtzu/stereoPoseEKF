...
public:
	...
	void setStereoParam(double u0, double v0, double f, double B)
	{
		this->u0 = u0;
		this->v0 = v0;
		this->f = f;
	...
	bool computeDepth(std::vector<cv::KeyPoint>* ptrFt0, std::vector<cv::KeyPoint>* ptrFt1,
			std::vector<arma::mat>* ptrCovFt0, std::vector<arma::mat>* ptrCovFt1, std::vector<cv::Vec3f>& vctPt);

	bool computeDepthWtCov(std::vector<cv::KeyPoint>* ptrFt0, std::vector<cv::KeyPoint>* ptrFt1, std::vector<cv::Vec3f>& vctPt,
					 	 	 std::vector<arma::mat>* ptrCovFt0, std::vector<arma::mat>* ptrCovFt1, std::vector<arma::mat>& vctCovPt);
